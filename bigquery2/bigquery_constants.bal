...
final string JSON_EXTRACTION_ERROR_MSG = "Error occurred while accessing the JSON payload of the response";
final string API_INVOCATION_ERROR_MSG = "Error occurred while invoking the REST API";
